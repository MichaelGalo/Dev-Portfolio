  ...
  return (
    <>
      ...
      <div className="mb-4 border-b border-gray-200 dark:border-gray-700">
        ...
        >
          <li className="me-2" role="presentation">
            <button
              className={`inline-block p-4 border-b-2 rounded-t-lg ${
                activeTab === "server" ? "text-purple-600 border-purple-600" : ""
              }`}
              id="server-styled-tab"
              type="button"
              role="tab"
          ...
          <li className="me-2" role="presentation">
            <button
              className={`inline-block p-4 border-b-2 rounded-t-lg ${
                activeTab === "client-capstone" ? "text-purple-600 border-purple-600" : ""
              }`}
              id="client-capstone-styled-tab"
              type="button"
              role="tab"
              aria-controls="client-capstone"
              aria-selected={activeTab === "client-capstone"}
              onClick={() => handleTabClick("client-capstone")}
            >
          ...
          <li className="me-2" role="presentation">
            <button
              className={`inline-block p-4 border-b-2 rounded-t-lg ${
                activeTab === "group" ? "text-purple-600 border-purple-600" : ""
              }`}
              id="group-styled-tab"
              type="button"
              role="tab"
          ...
          <li role="presentation">
            <button
              className={`inline-block p-4 border-b-2 rounded-t-lg ${
                activeTab === "individual" ? "text-purple-600 border-purple-600" : ""
              }`}
              id="individual-styled-tab"
              type="button"
              role="tab"
      ...
      <div id="default-styled-tab-content">
        ...
        {/* Client-capstone Tab Content */}
        <div
          className={`p-4 rounded-lg bg-gray-200 dark:bg-gray-800 ${
            activeTab === "client-capstone" ? "" : "hidden"
          }`}
          id="styled-client-capstone"
          role="tabpanel"
          aria-labelledby="client-capstone-tab"
        >
          <h3>
            <strong>
          ...
          <p className="text-sm text-black dark:text-gray-400">
            Roll-for-Recipe allows a user to create, read, update and delete recipes while also giving the functionality to pick however many recipes a user thinks they'll need to cook that week. It will take from your saved recipes (whether authored or favorited) and generate random options to select from. In addition it will automatically create a shopping list that can be utilized while grocery shopping.
            <br />
            <br />
        ...
        <div
          className={`p-4 rounded-lg bg-gray-200 dark:bg-gray-800 ${
            activeTab === "individual" ? "" : "hidden"
          }`}
          id="styled-individual"
          role="tabpanel"
        ...
        >
          ...
          <br />
          <hr className="border-t-2 border-gray-500 dark:border-gray-300 my-4" />
          <br />
          <h3>
            <strong>
