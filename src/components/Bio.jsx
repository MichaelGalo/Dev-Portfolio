...
<>
    <section id="bio" className="mb-8 max-w-4xl mx-auto">
        ...
        <p className="bg-gray-200 dark:bg-gray-800 p-4 rounded-lg shadow-md">
            ...
            <blockquote className="flex items-center justify-center my-6">
                    <p className="text-center italic text-lg">
                        "If you don't like the road you're walking, start paving another one!"
                        <footer className="mt-2 text-sm not-italic">- Dolly Parton</footer>
                    </p>
            </blockquote> 

            Transitioning from a first career in marketing & communications primarily for non-profits & B-Corp brands, I hadn't quite found the analytical challenge I was craving in my career. Combine this with a lego-filled childhood and the university path never walked named <strong>computer science</strong>, I decided to take Dolly's advice and pave my own path into: <strong>software development</strong>. 
            <br />
            <br />
